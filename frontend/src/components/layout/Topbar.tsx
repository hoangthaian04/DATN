  ...
  return (
    <header className="h-[64px] border-b border-slate-200 bg-white flex items-center justify-between px-6 sticky top-0 z-20 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <span className="bg-slate-100 border border-slate-200 text-slate-600 text-xs font-semibold px-2.5 py-1 rounded-full hidden sm:block">{user?.companyName}</span>
        <button
        ...
        <button
          onClick={() => user?.companySlug && window.open(`/company/${user.companySlug}`, '_blank')}
